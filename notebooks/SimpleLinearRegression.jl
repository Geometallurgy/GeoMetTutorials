...
# ╔═╡ e2532b28-a569-4b0c-8161-32d4d469f5fa
using DataFrames, GLM, StatsPlots, CSV, HTTP

# ╔═╡ a5e4dcee-671c-11f0-32cd-c743ddb9460c
begin


	csv_url = "https://zenodo.org/record/6587598/files/comminution.csv?download=1"
	...
	p = scatter(x, y, 
	    ...
	    xlabel = "th1", 
	    ylabel = "F80 (µm)", 
	    title = "Relação entre th1 e F80",
	    markersize = 5,
	    markercolor = :blue)
	
	
	model = lm(@formula(F80 ~ th1), df)
	...
	plot!(x, a .+ b .* x, 
	    label = "Regressão: F80 = $(round(a, digits=1)) + $(round(b, digits=1))·th1",
	    linewidth = 2, 
	    color = :red,
	    linestyle = :dash)
	...
	println("Coeficiente linear (intercepto): ", round(a, digits=2))
	println("Coeficiente angular: ", round(b, digits=2))
	println("R²: ", round(r2(model), digits=3))


end

# ╔═╡ 658f3613-b3c8-402a-b18a-f299e8accd63
p

# ╔═╡ 9838623a-048d-406d-878f-d6bb44501d65
...
manifest_format = "2.0"
project_hash = "ccadce3f66c3085ef91d5439d06c876a055ed5ec"
